...
asm_strchr:	; setup & variables init
	...
	mov	QWORD [rbp-8], rdi	; copy given str ptr dest to local rbp 8
	mov	eax, esi		; make a char ptr to store the target char
	mov	BYTE [rbp-12], al	; copy given char ptr dest to local rbp 12
